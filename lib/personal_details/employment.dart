...
import 'package:jobportalapp/personal_details/employment_information.dart';
        ...
        body: SingleChildScrollView(
          child: Column(
            children: <Widget>[
              ...
              InkWell(
                onTap: (){
                  Navigator.of(context).push(MaterialPageRoute(builder: (context)=>EmploymentInformation()));
                },
                child: Container(
                  child: Stack(
                    children: <Widget>[
